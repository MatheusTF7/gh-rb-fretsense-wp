...
const messages: typeof enUS = {
  ...
  home: {
    ...
    notice:
      'Exercícios iniciais de strum, HOPO, tapping, acordes e sustains estão disponíveis na área de treino.',
  ...
  play: {
    ...
    setupDescription: 'Escolha entrada, padrão, articulação, cauda e timing para uma tentativa reproduzível.',
