...
const messages: typeof english = {
  ...
  saved: 'Ajuste salvo: entrada {input} ms e visual {visual} ms.',
  restored: 'Último ajuste recarregado: entrada {input} ms e visual {visual} ms. No modo com áudio, prepare e confirme a saída antes de iniciar.',
