export default {
  ...
  saved: 'Adjustment saved: input {input} ms and visual {visual} ms.',
  restored: 'Latest adjustment restored: input {input} ms and visual {visual} ms. In audio mode, prepare and confirm the output before starting.',
