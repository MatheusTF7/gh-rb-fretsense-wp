...
export default {
  ...
  home: {
    ...
    notice:
      'The first strum, tapping, sequence and chord exercises are ready in the practice space.',
  ...
  catalog: {
    ...
    notice:
      'The first beginner exercises are available for single strum, tapping, sequences and chords. The other families remain a guide to planned techniques.',
  ...
  play: {
    ...
    setupDescription: 'Choose input, pattern and timing. HOPO and sustains are intentionally unavailable in this stage.',
    profile: 'Input profile', connection: 'Gamepad connection', pattern: 'Pattern', articulation: 'Articulation',
    chordSize: 'Note size', bpm: 'BPM', repetitions: 'Repetitions', audio: 'Metronome', calibration: 'Calibration',
    ...
    keyboardHelp: 'Default keyboard: A/S/D/F/G for frets and Escape to pause. With automatic strum, press the note fret; arrow up/down remain available for manual strum.',
    ...
    sessionStatus: 'Current attempt status', combo: 'Combo', notes: 'Resolved notes', input: 'Inputs', progress: 'Exercise progress',
    ...
    extraStrums: 'Extra strums', duration: 'Active duration', unavailable: 'Unavailable',
