...
**Estado:** especificação, contratos, núcleo, adaptadores, relógio/áudio/calibração, julgamento e integração jogável até a etapa 08 revisados por análise estática manual. HOPO, tapping, direção e sustains seguem as regras abaixo; o catálogo procedural completo permanece na etapa 09 do [plano de desenvolvimento](./fretsense-development-plan.md). O escopo está descrito em [núcleo inicial](./engine-foundation.md), [entrada e preferências](./input-and-preferences.md), [relógio e calibração](./timing-and-calibration.md), [julgamento inicial](./initial-judgment.md), [treino jogável](./playable-training.md) e [articulações e sustains](./articulations-and-sustains.md), sem confirmação em execução.
